...
_DEPS = render/sprite.h render/shader.h render/texman.h phys.h helper/list.h const.h game.h helper/easing.h event.h player.h obstacle.h func.h proj.h
DEPS = $(patsubst %,$(IDIR)/%,$(_DEPS))

_OBJ = main.o render/shader.o render/sprite.o helper/glad.o render/texman.o phys.o helper/list.o game.o helper/easing.o event.o player.o obstacle.o func.o proj.o
